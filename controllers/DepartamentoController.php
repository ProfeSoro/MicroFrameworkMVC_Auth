...
class DepartamentoController {
    ...
    public function listar() {
        ...
        $this->view->show("departamentoListarView.php", $data);
    }
    ...
    public function nuevo() {
        ...
        if (isset($_REQUEST['submit'])) {
            ...
            if (empty($errores)) {
                ...
                header("Location: index.php?controlador=Departamento&accion=listar");
                exit;
            }
        }

        // Si no recibe el item para añadir, devuelve la vista para añadir un nuevo item
        $this->view->show("DepartamentoNuevoView.php", array('errores' => $errores));
    ...
    public function editar() {
        ...
        $this->view->show("departamentoEditarView.php", array('item' => $item, 'errores' => $errores));
